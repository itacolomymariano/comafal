...
If lComercial .Or. lIndustria
   ...
   ***************/
   ...
   For nMes := 1 To 3
      ...
      cQrySD2 := "SELECT COUNT(DISTINCT D2_PEDIDO) AS PEDFAT" //Pedidos Faturados(Mês) - Quantidade
      ...
      cQry2SD2 := "SELECT SUM(D2_TOTAL) AS VLRFATPED,SUM(D2_QUANT) AS QTDFATPED"  //Pedidos Faturados(Mês) - Valor
      ...
      cQry2SC6 := "SELECT COUNT(DISTINCT SC6.C6_NUM) AS PEDPEND" //Pedidos Pendentes(Mês) - Quantidade
      ...
      cQry3SC6 := "SELECT SUM(SC6.C6_VALOR) AS VLRPEDPEND" //Pedidos Pendentes(Mês) - Valor
