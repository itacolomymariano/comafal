...
/*
//Naturezas - (M.O. + BENEFICIAMENTO + MANUTENÇÃO + SERVICO TERCEIRIZADO + EPI + INSUMOS + ENERGIA + AGUA + ALUGUEL)
...
//Nova Versão de Naturezas - Patrícia: 13/02/2008
//Naturezas - (M.O. + BENEFICIAMENTO + MANUTENÇÃO + SERVICO TERCEIRIZADO + EPI + INSUMOS + ENERGIA + AGUA + ALUGUEL) / (QTD. TONELADAS PRODUZIDAS) 
...
Private cGGNatComl := "100120,100201,100202,100203,100204,100206,100207,100208,100209,100210,100211,100212,100213,100214,100215,100216,100222,"
        ...
        cGGNatComl += "100217" //Five Solutions Consultoria - 26/08/2008 - Solicitação: Patrícia Méllo/Roberto Lira
        //cGGNatComl += "100315" //Five Solutions Consultoria - 26/08/2008 - Solicitação: Patrícia Méllo/Roberto Lira
        //cNtGstMtOrInd += "100217"//Five Solutions Consultoria - 26/08/2008 - Solicitação: Patrícia Méllo/Roberto Lira
...
//Alteração Patrícia 23/02/2008 - Retirar 100216 de Gastos Mão-de-Obra Comercial
//Naturezas de Gastos Gerais Mão de Obra
...
/*
//Naturezas de Despesas Periódicas
...
//Naturezas de Rescisões
Private cNResGG    := "100211,100222"
//Naturezas de Premiações
...
//Alteração Patrícia - 23/02/2008 - Incluir 100216 me Outras Naturas do Comercial
//Naturezas de Outras Naturezas
...
Private cNtGMtOrCml:= "100204,100206,100207,100208,100209,100214,200201,200202,200203,200205,200206,600303,"
        cNtGMtOrCml+= "100217"//Five Solutions Consultoria - 26/08/2008 Solicitação: Patrícia Méllo/Roberto Lira.
        //cNtGMtOrCml+= "100315"//Five Solutions Consultoria - 26/08/2008 Solicitação: Patrícia Méllo/Roberto Lira.
        //cNtGstMtOrInd += "100217"//Five Solutions Consultoria - 26/08/2008 - Solicitação: Patrícia Méllo/Roberto Lira
/*
...
*/
//Nova versão de naturezas - Patrícia 13/02/2008
//(M.O. + BENEFICIAMENTO +MANUTENÇÃO +SERVICO TERCEIRIZADO+EPI+INSUMOS+ENERGIA+AGUA+ALUGUEL)
...
Private cGASTGERIND := "100301,100302,100303,100304,100305,100306,100307,100308,100309,100310,100311,100312,100313,100317,100401,100402,100403,100404,100405,100406,100407,100408,100409,100410,100411,100412,100417,200109,"
        ...
        cGASTGERIND += "100315" //Five Solutions Consultoria - 26/08/2008 Solitição: Patricia Méllo/Roberto Lira 
        //cGASTGERIND += "100217" //Five Solutions Consultoria - 26/08/2008 Solitição: Patricia Méllo/Roberto Lira
        //cGGNatComl += "100315" //Five Solutions Consultoria - 26/08/2008 - Solicitação: Patrícia Méllo/Roberto Lira
...
//Nova alteração - Patrícia - 20/02/2008 - Movido naturezas 100308,100408 de Mão-de-Obra e Despesas periódicas p/ Outras Naturezas
Private cNtMaoObInd:="100301,100302,100303,100304,100305,100306,100307,100309,100310,100311,100312,100313,100317,100401,100402,100403,100404,100405,100406,100407,100409,100410,100411,100412,100417"
...
//CONSERVAÇÃO DE PREDIO Indústria 
Private cNtCoPredInd:= "200321,200421"
//DESPESAS DE VIAGENS  Indústria 
Private cNtDespViaIn:= "200304,200404"
//OUTRAS DESPESAS DA INDÚSTRIA  Indústria 
//Private cNtOutDesInd := "200316,200416"


//OUTRAS DESPESAS DAS INDÚSTRIA
...
//Correção no ato da reunião
Private cNtOutDesInd := "200316"

/*
//OUTRAS NATUREZAS DA INDÚSTRIA 
...
/*
//TOTAL DE GASTOS REALIZADOS NAS NATUREZAS QUE COMPÕE AS METAS DE ORÇAMENTO
...
Private cNtGstMtOrInd := "100303,100305,100306,100307,100311,100312,100403,100405,100406,100407,100411,100412,200302,200304,200305,200308,200309,200310,200311,200312,200316,200317,200318,200319,200320,200321,"
        ...
        cNtGstMtOrInd += "100315"//Five Solutions Consultoria - 26/08/2008 - Solicitação: Patrícia Méllo/Roberto Lira 
        //cNtGstMtOrInd += "100217"//Five Solutions Consultoria - 26/08/2008 - Solicitação: Patrícia Méllo/Roberto Lira
        //cGGNatComl += "100315" //Five Solutions Consultoria - 26/08/2008 - Solicitação: Patrícia Méllo/Roberto Lira
/*        
...
/*  Comentado para pegar nova versão de naturezas disponibilizada por Patrícia em 28/05/2008
...
*/
//Nova versão dNaturezas 13/02/2008
//MAO DE OBRA ADM 
...
//Nova versão dNaturezas 23/02/2008
//MAO DE OBRA ADM 
...
//DESPESA FIXA "100103,100105,100106,100107,100111,100114,100116,100117" - Versão 18/03/2008
Private cDFGstADM := "100103,100105,100106,100107,100111,100114,100116,100117"

//DESPESA PERIÓDICA ADM 
//Private cDPGstADM := "100101,100104,100109,100113,100119,100121"
// DESPESA PERIÓDICA "100101,100104,100109,100119,100121" - Versão 18/03/2008
...
//OUTRAS NATUREZAS DO ADMINISTRATIVO FINANCEIRO - Nova versão 18/03/2008
...
/*
//TOTAL DE GASTOS REALIZADOS NAS NATUREZAS QUE COMPÕE AS METAS DE ORÇAMENTO ADM
...
//TOTAL DE GASTOS REALIZADOS NAS NATUREZAS QUE COMPÕE AS METAS DE ORÇAMENTO  - Versão 18/03/2008
//Five Solutions - 28/08/2008 - Conforme Solicitação de Patrícial Mélo e Autorização da Diretoria COMAFAL
// Foram retiradas as naturezas 500102, 500103 e 500104”, respectivamente “Despesas de Viagem da Diretoria, INSS da Diretoria e Plano de Saúde da Diretoria” das metas de orçamento do Administrativo
/*
 ...
 * que é pegar os valores orçados no cadastro de orçamentos - SE7

nComMtOrc := 0 //Meta Orçamento Comércio
nIndMtOrc := 0 //Meta Orçamento Indústria
nAdmMtOrc := 0 //Meta Orçamento Administração
*/
...
//SALARIOS PRODUÇÃO: TODAS AS DESPESAS DA M.O. DA INDÚSTRIA INCLUINDO A SUA AREA ADMINISTRATIVA 
...
//TODAS AS DESPESAS DO COMERCIAL (EXCLUI A NATUREZA DE EMPRÉSTIMO E REEMBOLSO A CLIENTE)
...
//TOTAL DE DESPESAS ADMINISTRATIVAS (EXCLUI EMPRÉSTIMOS, IMPOSTOS(Fica o INSS da Diretoria, FGTS e GRFC) E OUTRAS...)
/*
...
nComMtOrc := MV_PAR07 //Meta Orçamento Comércio
nIndMtOrc := MV_PAR08 //Meta Orçamento Indústria
nAdmMtOrc := MV_PAR09 //Meta Orçamento Administração
*/
...
titulo       := "Resumo Gerencial COMAFAL Período "+DtoC(dDataDe)+" a "+DtoC(dDataAte)+" Emp/Fil: "+Alltrim(SM0->M0_NOME)+"/"+Alltrim(SM0->M0_FILIAL)
...
While lRoda//!EOF()
   ...
   If lComercial
      ...
      */
      ...
      //Custo da Matéria Prima = Custo do Faturamento somado ao Custo de Faturamento Sucata dividido pela
      ...
      @nLin,000 PSAY "| * Matéria Prima (Ton)             |"
      ...
      //Solicitação: Gilmar Filho / Patrícia.
...
//      Alert("Imprimindo o Valor nQtdFM1MEst "+Alltrim(Str(nQtdFM1MEst)))
      ...
      If (nVlMU1MInd+nVlMU2MInd+nVlMU3MInd) > 0
         ...
         @nLin,000 PSAY "| * Moveis e Utensílios             |"
...
*/
      ...
      */
      ...
      /* Retirado Página conforme solicitação de Patrícia - 15/02/2008
...
*******************************************************************************************************************
      ...
      */  // Fim - Retirado Página conforme solicitação de Patrícia - 15/02/2008
   ...
   If lDemonsRes
      ...
      */
      ...
      /*Fim da Manutenção dos Impostos - Valores Zerados*/
      ...
      */
      ...
      //Novo tratamento p/Custo da Materia Prima - Solicitação de Patrícia - 18/03/2008(Total de Custo(-)Impostos)
      /*
      ...
      */
      ...
      If nLin > nLRel //55 // Salto de Página. Neste caso o formulario tem 55 linhas...
         ...
         nLin := 8
      Endif
      //CUSTO LANÇADO NO SISTEMA "NELSON"
      //Novo tratamento p/Custo da Materia Prima - Solicitação de Patrícia - 18/03/2008(Total de Custo(-)Impostos)
      /*
      nMPCst1M := (nCMP1Mes+nVlM1CusSUC) - nImp1SVend
      nMPCst2M := (nCMP2Mes+nVlM2CusSUC) - nImp2SVend
      ...
      */
      ...
      If nLin > nLRel //55 // Salto de Página. Neste caso o formulario tem 55 linhas...
         ...
         nLin := 8
      Endif
      //SALARIOS PRODUÇÃO: TODAS AS DESPESAS DA M.O. DA INDÚSTRIA INCLUINDO A SUA AREA ADMINISTRATIVA '100301','100302','100303','100304','100305','100306','100307',
      ...
      */
      ...
      If nLin > nLRel //55 // Salto de Página. Neste caso o formulario tem 55 linhas...
         ...
         nLin := 8
      Endif
      //Salarios Adm Industria - COMO NÃO TINHA COMO SEPARAR, JÁ FOI LANÇADO JUNTAMENTE COM O CUSTO DO SALÁRIO DA PRODUÇÃO
      ...
      If nLin > nLRel //55 // Salto de Página. Neste caso o formulario tem 55 linhas...
         ...
         nLin := 8
      Endif
      //MANUTENÇÃO '200317','200318','200319','200417','200418','200419'
      @nLin,000 PSAY "|   * Manutenção                    |" //
      @nLin,051 PSAY  nMan1IndVl  Picture "@E 999,999,999.99"
      @nLin,066 PSAY "|"
      @nLin,081 PSAY nMan2IndVl Picture "@E 999,999,999.99"
      ...
      If nLin > nLRel //55 // Salto de Página. Neste caso o formulario tem 55 linhas...
         ...
         nLin := 8
      Endif
      //SERVIÇOS TERCEIRIZADOS '200303','200403'
      @nLin,000 PSAY "|   * Serviços Terceirizados        |" //
      @nLin,051 PSAY  nSTc1IndVl  Picture "@E 999,999,999.99"
      @nLin,066 PSAY "|"
      @nLin,081 PSAY nSTc2IndVl Picture "@E 999,999,999.99"
      ...
      //OUTRAS DESPESAS DAS INDÚSTRIA
      //'200321','200421','200304','200404','200316','200416','200301','200302','200305','200307','200315','200401','200402','200405','200407','600301','600501','700301','700304'
      @nLin,000 PSAY "|   * Outras Despesas Indústria     |" //
      @nLin,051 PSAY  nODp1IndVl  Picture "@E 999,999,999.99"
      @nLin,066 PSAY "|"
      @nLin,081 PSAY nODp2IndVl Picture "@E 999,999,999.99"
      @nLin,096 PSAY "|"
      ...
      */
      ...
      //(TUDO QUE É VENDIDO QUE NAO ESTA LIGADO A ATIVIDADE PRINCIPAL DA EMPRESA - EX.: VENDA DE IMOBILIZADO, AÇÕES…)
      nRes1MNOLiq := (0)
      nRes2MNOLiq := (0)
      nRes3MNOLiq := (0)
      
      @nLin,000 PSAY "|Resultado Não Operacional Líquido  |" //
      ...
      @nLin,000 PSAY "|PROVISÃO PARA O CSLL               |" //
      ...
      @nLin,000 PSAY "|PROVISÃO PARA O IR                 |" //
      ...
      @nLin,000 PSAY "|LUCRO LÍQUIDO DO EXERCÍCIO         |" //
...
If lComercial .Or. lIndustria
   ...
   *********************************/
   ...
   For nMes := 1 To 3  //Faturamento Bruto por Condição de Faturamento(Pagamento)
   ...
   **************************/   
   ...
   For nMes := 1 To 3
      ...
      IncProc("Calc. Devoluções de Clientes, Proc. "+Alltrim(Str(nMes))+" / 3")
   ...
   ********************************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Calc. Produção, Processo "+Alltrim(Str(nMes))+" / 3")
   ...
   ************************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Calc. Comissões, Processo "+Alltrim(Str(nMes))+" / 3")
   ...
   *********************************/
   ...
   For nMes := 1 To 3
      ...
      cQuery += " AND SF2.F2_FILIAL  = '"+xFilial("SF2")+"' AND  SF2.D_E_L_E_T_ = ' ' "
      cQuery += " AND SD2.D2_COD = SB1.B1_COD"
      cQuery += " AND SUBSTRING(SB1.B1_GRUPO,1,2) = '80'" //Só Faturamento Sucatas
      cQuery += " AND SF2.F2_DOC = SD2.D2_DOC"
      cQuery += " AND SF2.F2_SERIE = SD2.D2_SERIE"
      cQuery += " AND SD2.D2_CF IN "+FormatIn(cCFOPVenda,",")
      cQuery += " AND (SD2.D2_TIPO <> 'I')" //Five Solutions(07/04/2008)
...
If lIndustria
   ...
   ************************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Calc. Produção Maq.Ind. Proc. "+Alltrim(Str(nMes))+" / 3")
...
//         Alert("Peguei o Valor nQtdFM1MEst "+Alltrim(Str(nQtdFM1MEst)))
   ...
   ***************************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Calc. Custo Produção, Proc. "+Alltrim(Str(nMes))+" / 3")
   ...
   ***************************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Calc. Mov. Utensílios, Proc. "+Alltrim(Str(nMes))+" / 3")
   ...
   *****************************************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Gastos Metas/Orc.Industria(Orçado), Proc. "+Alltrim(Str(nMes))+" / 3")
...
If lAdmFin
   ...
   ***********************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Calc. Títulos A Pagar, Proc. "+Alltrim(Str(nMes))+" / 3")
   ...
   *************************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Calc. Bx.p/Compensação, Proc. "+Alltrim(Str(nMes))+" / 3")
   ...
   *************************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Calc. Bx.p/Devolução, Proc. "+Alltrim(Str(nMes))+" / 3")
...
*/
   ...
   *************************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Calc. Bx.p/Compensação(REC), Proc. "+Alltrim(Str(nMes))+" / 3")
   ...
   *************************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Calc.Bx.p/Devolução(REC), Proc. "+Alltrim(Str(nMes))+" / 3")
   ...
   ******************/
   ...
   For nMes := 1 To 15
      ...
      IncProc("Calc. Tít. Vencidos, Proc. "+Alltrim(Str(nMes))+" / 15")
...
*/
   ...
   ************************/
   ...
   For nMes := 1 To 3
      ...
      IncProc("Gastos Metas/Orc Adm/Fin.(Orçado) Proc. "+Alltrim(Str(nMes))+" / 3")
   ...
   ************************/
   ProcRegua(36)
   For nMes := 1 To 36 //1 A 3 - Impostos Contribuição Total.
                      //4 A 6 - INSS
                      //7 A 9 - FGTS
                      //10 A 12 - CPMF
                      //13 A 15 - IPTU
      ...
      IncProc(" Impostos e Contribuição Proc. "+Alltrim(Str(nMes))+" / 36")
...
If lDemonsRes
   ...
   For nMes := 1 To 6  //Faturamento por Condição(Pagamento) A Vista/A Prazo
