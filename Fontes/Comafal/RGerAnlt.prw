...
±±∫Desc.     ≥ Relatorio Gerencial Analitico - Visıes Comercial, Industrial±±
±±∫          ≥ Administrativo e Resumo de Despesas/Receitas.              ∫±±
±±∫          ≥ RelatÛrio Desenvolvido em Modelo Grafico: TReport          ∫±±
...
Static Function RNatCom(nOpVis,nProc)
   ...
   If nOpVis == 2 //Vis„o Comercial
      ...
      aAdd(aMsg,"ServiÁos Terceirizados")
   ...
   For nCom := 1 To nProc
      ...
      cQryCOM += "   AND SE5.E5_MOTBX <> 'DEV'" //Five Solutions Consultoria - 25/11/2010 - SolicitaÁ„o de PatrÌcia  
...
Static Function MontPerg
   ...
   Aadd( aHelpPor, 'Informe quais visıes desea visualizar')

                                                                                                           //F3
 //PutSx1(cPerg ,"05","Depto.?" ,""       ,""     ,"mv_ch5","C"  ,1        ,0       ,0      ,"C" ,""    ,"" ,""     ,"","MV_PAR05","Todos","","",""    ,"Faturamento","","","Industria" ,"","","Financeiro"    ,"","","Gerencial","","")
   PutSx1(cPerg ,"03","Visıes"  ,"Visıes","Visıes","mv_ch3","N"  ,01       ,0       ,0      ,"C" ,""    ,"" ,""     ,"","MV_PAR03","Todas","","",""    ,"Comercial"  ,"","","Industrial","","","Administrativo","","","Despesas/Receitas","","",aHelpPor,aHelpEng,aHelpSpa)
