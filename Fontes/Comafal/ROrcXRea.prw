...
±±ºPrograma  ³ROrcXRea  º Autor ³ Five Solutions     º Data ³  28/05/2008 º±±
...
* Saldo     : Do Orçado subtrair o Realizado e o A Realizar.
* Alterado o Indicador Percentual de Variação para Percentual de Utilização
* Solicitação : Patricia Melo e Roberto Lira
*******************************************************************************/
...
//Saldo(Orçado - (Rrealizado + A Realizar))
nSld1GG     := 0
nSld2GG     := 0
nSld3GG     := 0
nSld4GG     := 0
...
//Naturezas de GASTOS META ORCAMENTO COML versão de Naturezas - Patrícia 13/02/2008
...
//METAS DE ORÇAMENTO PARA O COMÉRCIO EXTERIOR
...
//TOTAL DE GASTOS REALIZADOS NAS NATUREZAS QUE COMPÕE AS METAS DE ORÇAMENTO DA INDUSTRIA
...
//NATUREZAS QUE COMPÕEM AS METAS DE ORÇAMENTO ADM
...
titulo       := "Mapa Comparativo de Naturezas - Orçados X Real - Emp/Fil: "+Alltrim(SM0->M0_NOME)+"/"+Alltrim(SM0->M0_FILIAL)
...
If lAdmFin
   ...
   ************************/
   ...
   //   IncProc(" Calc.Gastos Gerais Adm. Proc. "+Alltrim(Str(nMes))+" / 12")
      ...
      //Implementado em 08/07/2008 - Solicitação: Patricia
...
*******************************************************************************************************************
   ...
   For nVez := 1 To 2
      ...
      While !EOF()
         ...
         // xxxxxxxxxX xxxxxxxxxXxxxxxxxxxXxxx Orçado 999,999,999.99 999,999,999.99 999,999,999.99 999,999,999.99 999,999,999.99 999,999,999.99 999,999,999.99 999,999,999.99 999,999,999.99 999,999,999.99 999,999,999.99 999,999,999.99
         //                                      Real
         //                                   ARealiz
         //                                     Saldo
         //                                   %Utiliz
      ...
      **************************************************/
      ...
      If nVez == 1
         @nLin,000 PSAY "Tt Orçado de Gastos Gerais Adm/Fin "
      Else
        @nLin,000 PSAY "Tot.Metas Orçado Gastos Ger.Adm/Fin "
      EndIf
...
*******************************************************************************************************************
   ...
   For nVez := 1 To 2
      ...
      **************************************************/
      ...
      If nVez == 1
         @nLin,000 PSAY "Tt Orçado de Gastos Gerais Comércio "
      Else
        @nLin,000 PSAY "Tot.Metas Orçado Gastos Ger.Com.... "
      EndIf
      @nLin,042 PSAY nOrc1GADM  Picture "@E 999,999,999.99"
      @nLin,057 PSAY nOrc2GADM  Picture "@E 999,999,999.99"
      @nLin,072 PSAY nOrc3GADM  Picture "@E 999,999,999.99"
      ...
      If nVez == 1
         @nLin,000 PSAY "Tt Realizado de Gastos Gerais Comércio "
      Else
         @nLin,000 PSAY "Tot.Metas Realiz.Gastos Ger.Comércio "
      EndIf
      ...
      If nVez == 1
         @nLin,000 PSAY "Tt A Realizar de Gastos Gerais Comércio "
      Else
         @nLin,000 PSAY "Tot.Metas A Realiz.Gastos Ger.Comércio "
      EndIf
      ...
      If nVez == 1
         @nLin,000 PSAY "Tt % Utilização de Gastos Gerais Comércio"
      Else
         @nLin,000 PSAY "Tot.Metas % Utiliz.Gastos Ger.Comércio"
      EndIf
...
*******************************************************************************************************************
   ...
   For nVez := 1 To 2
      ...
      **************************************************/
      ...
      If nVez == 1
         @nLin,000 PSAY "Tt Orçado de Gastos Ger.Com.Exterior "
      Else
        @nLin,000 PSAY "Tot.Metas Orçado Gastos Ger.Com.Ext. "
      EndIf
      @nLin,042 PSAY nOrc1GADM  Picture "@E 999,999,999.99"
      @nLin,057 PSAY nOrc2GADM  Picture "@E 999,999,999.99"
      @nLin,072 PSAY nOrc3GADM  Picture "@E 999,999,999.99"
...
*******************************************************************************************************************
   ...
   /************************
   *
   * GASTOS GERAIS INDÚSTRIA (A REALIZAR)
   *
   ************************/
...
*******************************************************************************************************************
   ...
   For nVez := 1 To 2
      ...
      **************************************************/
      ...
      If nVez == 1
         @nLin,000 PSAY "Tt Orçado de Gastos Gerais Indústria "
      Else
        @nLin,000 PSAY "Tot.Metas Orçado Gastos Ger.Indúst. "
      EndIf
      @nLin,042 PSAY nOrc1GADM  Picture "@E 999,999,999.99"
      @nLin,057 PSAY nOrc2GADM  Picture "@E 999,999,999.99"
      @nLin,072 PSAY nOrc3GADM  Picture "@E 999,999,999.99"
      ...
      If nVez == 1
         @nLin,000 PSAY "Tt Realizado de Gastos Ger.Indústria "
      Else
         @nLin,000 PSAY "Tot.Metas Realiz.Gastos Ger. Indústria "
      EndIf
      ...
      If nVez == 1
         @nLin,000 PSAY "Tt A Realizar Gastos Ger.Indústria "
      Else
         @nLin,000 PSAY "Tot.Metas A Realiz.Gastos Ger.Indústria "
      EndIf
      ...
      If nVez == 1
         @nLin,000 PSAY "Tt % Utiliz.Gastos Gerais Indústria"
      Else
...
*******************************************************************************************************************
   ...
   For nVez := 1 To 1 //2 - Especificamente p/ Naturezas Diversas, o sistema só apresentará Gastos Gerais.
      ...
      **************************************************/
      ...
      If nVez == 1
         @nLin,000 PSAY "Tt Orçado de Gastos Gerais Nat.Diversas "
      Else
        @nLin,000 PSAY "Tot.Metas Orç.Gastos Gerais Nat.Diversas "
      EndIf
      @nLin,042 PSAY nOrc1GADM  Picture "@E 999,999,999.99"
      @nLin,057 PSAY nOrc2GADM  Picture "@E 999,999,999.99"
      @nLin,072 PSAY nOrc3GADM  Picture "@E 999,999,999.99"
...
@nLin,000 PSAY "Tt Global de Gastos Gerais Orçados "
