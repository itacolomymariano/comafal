...
±±ºPrograma  ³VLDCGCCTB ºAutor  ³Five Solutions      º Data ³  02/07/2008 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Verificação do CNPJ/CPF Digitado                           º±±
±±º          ³                                                            º±±
...
User Function VldCGCCTB
	...
	DbSelectArea(cAreaAntes)
   	DEFINE MSDIALOG oDlgCGC FROM 0,0 TO 250,700 TITLE "Validação do CNPJ/Cta. Contábil" Of oMainWnd PIXEL
	...
	//@ 012,130 SAY "Inicio "+DTOC(DtIniExp)+" as "+HrIniExp+" hs / Término "+DTOC(Date())+" as "+Time()+" hs" Of oDlgCGC PIXEL SIZE 200,88 FONT oFtTmp
	...
	If !Empty(cCtaExit)
	   @ 052,50 SAY "A Conta Contábil "+Alltrim(cCtaExit)+" já existe no Plano de Contas !!!" FONT oBold COLOR CLR_HRED Of oDlgCGC PIXEL SIZE 200,88
	Else
	   @ 052,50 SAY "Conta "+Alltrim(cCtaCtb)+" Disponível para inclusão no Plano de Contas !!!" FONT oBold Of oDlgCGC PIXEL SIZE 270,88
	EndIf
