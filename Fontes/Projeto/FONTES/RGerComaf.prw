...
While lRoda//!EOF()
   ...
   If lComercial
      ...
      */
      ...
      nMatPrim1Mes :=(nCus1MesFat/n1MTonelVen)
      nMatPrim2Mes :=(nCus2MesFat/n2MTonelVen)
      nMatPrim3Mes :=(nCus3MesFat/n3MTonelVen)
      ...
      @nLin,051 PSAY  nComMtOrc  Picture "@E 999,999,999.99"
      @nLin,066 PSAY "|"
      @nLin,081 PSAY  nComMtOrc Picture "@E 999,999,999.99"
      @nLin,096 PSAY "|"
      @nLin,112 PSAY  nComMtOrc Picture "@E 999,999,999.99"
      @nLin,127 PSAY "|"
      @nLin,134 PSAY "|"
      @nLin,149 PSAY  (0) Picture "@E 999,999,999.99" 
      @nLin,164 PSAY "|"
...
//      Alert("Imprimindo o Valor nQtdFM1MEst "+Alltrim(Str(nQtdFM1MEst)))
      ...
      @nLin,051 PSAY nIndMtOrc  Picture "@E 999,999,999.99"
      @nLin,066 PSAY "|"
      @nLin,081 PSAY nIndMtOrc Picture "@E 999,999,999.99"
      @nLin,096 PSAY "|"
      @nLin,112 PSAY nIndMtOrc Picture "@E 999,999,999.99"
      @nLin,127 PSAY "|"
      @nLin,134 PSAY "|"
      @nLin,149 PSAY  (0) Picture "@E 999,999,999.99" 
      @nLin,164 PSAY "|"
   ...
   If lAdmFin
      ...
      nPer1MInadpl := (nSld1MRec/nRe1MRealiz)
      nPer2MInadpl := (nSld2MRec/nRe2MRealiz)
      nPer3MInadpl := (nSld3MRec/nRe3MRealiz)
...
*******************************************************************************************************************      
      ...
      */
      ...
      @nLin,051 PSAY nAdmMtOrc Picture "@E 999,999,999.99" 
      @nLin,066 PSAY "|"
      @nLin,081 PSAY nAdmMtOrc Picture "@E 999,999,999.99" 
      @nLin,096 PSAY "|"
      @nLin,112 PSAY nAdmMtOrc Picture "@E 999,999,999.99" 
      @nLin,127 PSAY "|"
      @nLin,134 PSAY "|"
      @nLin,149 PSAY  (0) Picture "@E 999,999,999.99" 
      @nLin,164 PSAY "|"
...
If lComercial .Or. lIndustria
   ...
   *********************************/
   ...
   For nMes := 1 To 3  //Faturamento Bruto por Condição de Faturamento(Pagamento)
      ...
      cQuery := " SELECT SF2.F2_COND, SUM(SD2.D2_TOTAL+SD2.D2_VALIPI+SD2.D2_ICMSRET+SD2.D2_VALFRE+SD2.D2_SEGURO+SD2.D2_DESPESA) AS VALBRUTO FROM "
      cQuery += RetSqlName('SD2') + " SD2,"+RetSQLName("SB1")+" SB1,"+RetSQLName("SF2")+" SF2"
      cQuery += " WHERE SD2.D2_FILIAL  = '"+xFilial("SD2")+"' AND  SD2.D_E_L_E_T_ = ' ' "
      cQuery += " AND SB1.B1_FILIAL  = '"+xFilial("SB1")+"' AND  SB1.D_E_L_E_T_ = ' ' "
      cQuery += " AND SF2.F2_FILIAL  = '"+xFilial("SF2")+"' AND  SF2.D_E_L_E_T_ = ' ' "
   ...
   **********************************************************/
   ...
   For nMes := 1 To 3
      ...
      cQuery := " SELECT SF2.F2_COND,SUM(SD2.D2_TOTAL+SD2.D2_VALIPI+SD2.D2_ICMSRET+SD2.D2_VALFRE+SD2.D2_SEGURO+SD2.D2_DESPESA) AS VLRSUCAT FROM "
      cQuery += RetSqlName('SD2') + " SD2,"+RetSQLName("SB1")+" SB1,"+RetSQLName("SF2")+" SF2"
      cQuery += " WHERE SD2.D2_FILIAL  = '"+xFilial("SD2")+"' AND  SD2.D_E_L_E_T_ = ' ' "
      cQuery += " AND SB1.B1_FILIAL  = '"+xFilial("SB1")+"' AND  SB1.D_E_L_E_T_ = ' ' "
      cQuery += " AND SF2.F2_FILIAL  = '"+xFilial("SF2")+"' AND  SF2.D_E_L_E_T_ = ' ' "
...
If lDemonsRes
   ...
   For nMes := 1 To 6  //Faturamento por Condição(Pagamento) A Vista/A Prazo
      ...
      cQuery := " SELECT SUM(SD2.D2_TOTAL+SD2.D2_VALIPI+SD2.D2_ICMSRET+SD2.D2_VALFRE+SD2.D2_SEGURO+SD2.D2_DESPESA) AS VALBRUTO FROM "
      cQuery += RetSqlName('SD2') + " SD2,"+RetSQLName("SB1")+" SB1,"+RetSQLName("SF2")+" SF2"
      cQuery += " WHERE SD2.D2_FILIAL  = '"+xFilial("SD2")+"' AND  SD2.D_E_L_E_T_ = ' ' "
      cQuery += " AND SB1.B1_FILIAL  = '"+xFilial("SB1")+"' AND  SB1.D_E_L_E_T_ = ' ' "
      cQuery += " AND SF2.F2_FILIAL  = '"+xFilial("SF2")+"' AND  SF2.D_E_L_E_T_ = ' ' "
