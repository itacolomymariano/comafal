...
ฑฑบPrograma  ณMANTABPRC บAutor  ณFive Solutions      บ Data ณ  27/12/2010 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Tela de Manuten็ใo das Tabelas de Pre็o por Grupo/Subgrupo บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ COMAFAL - PE, SP e RS - Faturamento.                       บฑฑ
...
User Function ManTabPrc
   ...
   oFont1 := TFont():New("Arial",0,16,,.F.,,,,.T.,.T.,.F.) //Fonte อtalico Sublinhado
   
   Define MsDialog oDlgMTP Title "Manuten็ใo da Tabela de Pre็o" From 001,005 To 630,980 Of oMainWnd Pixel
...
*/   
   ...
   Else
      @025,115 SAY "de "+cSbGrpPrd+" "+cSGPrd+" At้ "+cSbGrpAte+" "+cSGAtPrd SIZE 300,10 FONT oFntMedia Of oDlgMTP PIXEL 
   EndIf
   
   If lTabUm
      @040,005 SAY "Novo Pre็o " SIZE 100,10 FONT oFntPeq Of oDlgMTP PIXEL 
   ...
   @ 055,007 LISTBOX oProds VAR cVarProds Fields HEADER "F","Produto","Descri็ใo","Tabela","Pre็o Atual","Pre็o Ajustado","Prc Tab Matriz" SIZE 470,220 NOSCROLL OF oDlgMTP PIXEL
   //@ 290,007 SAY "click duplo sobre no produto diferenciado ajusta pre็o manualmente" FONT oFont1 COLOR CLR_HBLUE OF oDlgMTP PIXEL
   ...
   */                                     
   ...
   @ 290,320 BUTTON OemToAnsi("&A t u a l i z a   T a b e l a s") SIZE 150,12 OF oDlgMTP PIXEL ACTION Processa({|| fAtMTP()},"Atualizando Tabelas de Pre็os ...") WHEN .T.
      ...
      Case cIndice=="Codigo"
           If !Empty(cCpoPsq)
              ...
              If (nA := Ascan(aProdTabs, {|x| Substr(x[1],1,nTamPsq) $ AllTrim(cCpoPsq) })) > 0
                 oProds:nAt := nA
              Else
                 Alert("O Codigo "+cCpoPsq+" nใo foi localizado em nehuma das tabelas de pre็os")
              EndIf
           Else
      ...
      Case cIndice=="Descricao"
           If !Empty(cCpoPsq)
              ...
              If (nA := Ascan(aProdTabs, {|x| Substr(x[2],1,nTamPsq) $ AllTrim(cCpoPsq) })) > 0
                 oProds:nAt := nA
              Else
                 Alert("A descri็ใo "+cCpoPsq+" nใo foi localizada em nehuma das tabelas de pre็os")
              EndIf
           Else
              MsgInfo("Informe a descri็ใo do produto.")
           EndIf
   End Do
...
Static Function fAtMTP()
   ...
   For nGrv := 1 To Len(aProdTabs)
      IncProc("Gravando novos pre็os reajustados ... "+Alltrim(Str(nGrv))+" / "+Alltrim(Str(nGrv)))
      ...
      MsUnLock()
   Next nGrv
   MsgInfo("Processo Concluํdo, "+Alltrim(Str(nGrv))+" Pre็os ajustados")
   oDlgMTP:End()
Return
...
Static Function RunAjtMan
   MsgInfo("Ajuste manual de pre็os")
Return
...
Static Function fQryMTP()
   ...
   nCont := 1
   While YMTP->(!Eof())
      //"F","Produto","Descri็ใo","Tabela","Pre็o Atual","Pre็o Ajustado"
      ...
      Else
         If lJurSimp
            ...
            Else
               ...
               If MsgYesNo("O Produto "+YMTP->DA1_CODPRO+" - "+cDescPrd+" nใo foi localiado na Tabela de Pre็o Matriz "+cTabMat+" o pre็o deste produto nใo serแ atualizado na tabela "+YMTP->DA1_CODTAB+" deseja criar o produto na Tabela Matriz com pre็o zerado ?")
                  ...
                  DbSelectArea("YMTP")
               Else
                  If MsgYesNo("Deseja EXCLUIR o Produto "+YMTP->DA1_CODPRO+" - "+cDescPrd+" da Tabela de Pre็o "+YMTP->DA1_CODTAB)
                     DbSelectArea("DA1")
                     nGoDA1 := YMTP->DA1REC
                     RecLock("DA1",.F.)
                        DELETE
...
Static Function MtPrgMTP
   ...
   Aadd( aHelpPor, 'deseja atualizar pre็os das tabelas de ')
 ...
 //PutSx1(cGrupo,cOrdem,cPergunt ,""     ,""     ,cVar    ,cTipo,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3,cGrpSxg,"",cVar01    ,cDef01 ,"","",cCnt01,cDef02       ,"","",cDef03,"","",cDef04,"","",cDef05,"","",aHelpPor,      "",     "",cHelp)
   PutSx1(xPerg ,"03"  ,"At้ Subgrupo"  ,"At้ Subgrupo","At้ Subgrupo","mv_ch3","C"  ,5       ,0       ,1      ,"G" ,""    ,"SZY" ,""     ,"","MV_PAR03","","","",""    ,""      ,"","",""    ,"","",""    ,"","",""    ,"","",aHelpPor,aHelpEng,aHelpSpa)
   ...
   Aadd( aHelpPor, 'pre็os do Grupo/Subgrupo.              ')
 ...
 //PutSx1(cGrupo,cOrdem,cPergunt ,""     ,""     ,cVar    ,cTipo,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3,cGrpSxg,"",cVar01    ,cDef01 ,"","",cCnt01,cDef02       ,"","",cDef03,"","",cDef04,"","",cDef05,"","",aHelpPor,      "",     "",cHelp)
   PutSx1(xPerg ,"06"  ,"At้ Produto"  ,"At้ Produto","At้ Produto","mv_ch6","C"  ,15       ,0       ,0      ,"G" ,""    ,"SB1" ,""     ,"","MV_PAR06","","","",""    ,""      ,"","",""    ,"","",""    ,"","",""    ,"","",aHelpPor,aHelpEng,aHelpSpa)
   
   aHelpPor := {}
   aHelpEng := {}
   aHelpSpa := {}

   Aadd( aHelpPor, 'Informe os c๓digos de produtos, separados ')
   Aadd( aHelpPor, 'por virgula, sobre os quais nใo serใo  ')
 ...
 //PutSx1(cGrupo,cOrdem,cPergunt ,""     ,""     ,cVar    ,cTipo,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3,cGrpSxg,"",cVar01    ,cDef01 ,"","",cCnt01,cDef02       ,"","",cDef03,"","",cDef04,"","",cDef05,"","",aHelpPor,      "",     "",cHelp)
   ...
   Aadd( aHelpPor, 'Codigo da Tabela de Pre็o inicial para')
 ...
 //PutSx1(cGrupo,cOrdem,cPergunt ,""     ,""     ,cVar    ,cTipo,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3,cGrpSxg,"",cVar01    ,cDef01 ,"","",cCnt01,cDef02       ,"","",cDef03,"","",cDef04,"","",cDef05,"","",aHelpPor,      "",     "",cHelp)
   ...
   Aadd( aHelpPor, 'Codigo da Tabela de Pre็o final   para')
   Aadd( aHelpPor, ' faixa total de Tabelas a ajustar.    ')

 //PutSx1(cGrupo,cOrdem,cPergunt ,""     ,""     ,cVar    ,cTipo,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3,cGrpSxg,"",cVar01    ,cDef01 ,"","",cCnt01,cDef02       ,"","",cDef03,"","",cDef04,"","",cDef05,"","",aHelpPor,      "",     "",cHelp)
   PutSx1(xPerg ,"09"  ,"At้ Tabela"  ,"At้ Tabela","At้ Tabela","mv_ch9","C"  ,3       ,0       ,0      ,"G" ,""    ,"DA0" ,""     ,"","MV_PAR09","","","",""    ,""      ,"","",""    ,"","",""    ,"","",""    ,"","",aHelpPor,aHelpEng,aHelpSpa)
   
   aHelpPor := {}
   aHelpEng := {}
   aHelpSpa := {}

   Aadd( aHelpPor, 'Informe os c๓digos das tabelas, separados ')
   Aadd( aHelpPor, 'por virgula, sobre os quais nใo serใo  ')
 ...
 //PutSx1(cGrupo,cOrdem,cPergunt ,""     ,""     ,cVar    ,cTipo,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3,cGrpSxg,"",cVar01    ,cDef01 ,"","",cCnt01,cDef02       ,"","",cDef03,"","",cDef04,"","",cDef05,"","",aHelpPor,      "",     "",cHelp)
   ...
   Aadd( aHelpPor, 'Codigo da Tabela de Pre็o Matriz')
   Aadd( aHelpPor, 'base para o reajuste dos pre็os ')
 ...
 //PutSx1(cGrupo,cOrdem,cPergunt ,""     ,""     ,cVar    ,cTipo,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3,cGrpSxg,"",cVar01    ,cDef01 ,"","",cCnt01,cDef02       ,"","",cDef03,"","",cDef04,"","",cDef05,"","",aHelpPor,      "",     "",cHelp)
   ...
   Aadd( aHelpPor, 'Informe se o tratamento serแ    ')
   Aadd( aHelpPor, 'realizado sobre a tabela Matriz ')

 //PutSx1(cGrupo,cOrdem,cPergunt             ,""                 ,""                 ,cVar    ,cTipo,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3,cGrpSxg,"",cVar01    ,cDef01 ,"","",cCnt01,cDef02       ,"","",cDef03,"","",cDef04,"","",cDef05,"","",aHelpPor,      "",     "",cHelp)
   PutSx1(xPerg ,"13"  ,"ษ Primeira Tabela ?"  ,"ษ Primeira Tabela ?","ษ Primeira Tabela ?","mv_chd","N"  ,1       ,0       ,1      ,"C" ,""    ,"" ,""     ,"","MV_PAR13","Sim"  ,"","",""    ,"Nใo"      ,"","",""    ,"","",""    ,"","",""    ,"","",aHelpPor,aHelpEng,aHelpSpa)

   aHelpPor := {}
   aHelpEng := {}
   aHelpSpa := {}
   
   Aadd( aHelpPor, 'Informe o pre็o para sele็ใo de produtos  ')
   Aadd( aHelpPor, 'definida nos parโmetros.               ')


 //PutSx1(cGrupo,cOrdem,cPergunt ,""     ,""     ,cVar    ,cTipo,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3,cGrpSxg,"",cVar01    ,cDef01 ,"","",cCnt01,cDef02       ,"","",cDef03,"","",cDef04,"","",cDef05,"","",aHelpPor,      "",     "",cHelp)
   PutSx1(xPerg ,"14"  ,"Aplicar Pre็o"  ,"Aplicar Pre็o","Aplicar Pre็o","mv_che","N"  ,17       ,2       ,0      ,"G" ,""    ,"" ,""     ,"","MV_PAR14","","","",""    ,""      ,"","",""    ,"","",""    ,"","",""    ,"","",aHelpPor,aHelpEng,aHelpSpa)
   
   aHelpPor := {}
   aHelpEng := {}
   aHelpSpa := {}

   Aadd( aHelpPor, 'Informe a Medida que serแ filtrada')
   Aadd( aHelpPor, 'na sele็ใo dos produtos. Se este  ')
   Aadd( aHelpPor, 'parโmetro nใo for preenchido serใo')
 ...
 //PutSx1(cGrupo,cOrdem,cPergunt             ,""                 ,""                 ,cVar    ,cTipo,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3,cGrpSxg,"",cVar01    ,cDef01 ,"","",cCnt01,cDef02       ,"","",cDef03,"","",cDef04,"","",cDef05,"","",aHelpPor,      "",     "",cHelp)
   ...
   Aadd( aHelpPor, 'filtrar apenas as tabelas padr๕es')
   Aadd( aHelpPor, 'de vendas, Ex.: Se COSP serใo    ')
   Aadd( aHelpPor, 'filtradas apenas tabelas com c๓di-')
   Aadd( aHelpPor, 'gos iniciados pela letra S, se   ')
   Aadd( aHelpPor, 'CORS serใo filtradas apenas tabe-')
   Aadd( aHelpPor, 'las iniciadas pela letra R e se  ')
   Aadd( aHelpPor, 'COPE serใo filtradas apenas tabe-')
   Aadd( aHelpPor, 'las iniciadas pela letra P. Do   ')
   Aadd( aHelpPor, 'contrแrio, informando N=Nใo o    ')
   Aadd( aHelpPor, 'sistema irแ ignorar este crit้rio')
   Aadd( aHelpPor, 'e apenas considera a faixa de    ')
   Aadd( aHelpPor, 'tabelas dos parโmetros 7,8 E 9.  ')

 //PutSx1(cGrupo,cOrdem,cPergunt             ,""                 ,""                 ,cVar    ,cTipo,nTamanho,nDecimal,nPresel,cGSC,cValid,cF3,cGrpSxg,"",cVar01    ,cDef01 ,"","",cCnt01,cDef02       ,"","",cDef03,"","",cDef04,"","",cDef05,"","",aHelpPor,      "",     "",cHelp)
   PutSx1(xPerg ,"17"  ,"Tabelas Padrใo Vendas"  ,"Tabelas Padrใo Vendas","Tabelas Padrใo Vendas","mv_chh","N"  ,1       ,0       ,1      ,"C" ,""    ,"" ,""     ,"","MV_PAR17","Sim"  ,"","",""    ,"Nใo"      ,"","",""    ,"","",""    ,"","",""    ,"","",aHelpPor,aHelpEng,aHelpSpa)
   */
   RestArea(aArea)
